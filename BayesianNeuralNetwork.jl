...
# ╔═╡ 4070eec6-9abd-11ed-07d2-d18caadce155
using Turing,FillArrays,Flux,Plots,ReverseDiff

# ╔═╡ 4d98c93e-97fa-45bd-ba69-ac1f193e042b
using Random,LinearAlgebra

# ╔═╡ 74e3fb49-cf43-418a-ab49-77618e84512b
md"# Bayesian Neural Network"

# ╔═╡ f252fd8f-162a-44a1-941d-e6ec3da9a949
Turing.setadbackend(:reversediff)

# ╔═╡ 6de72a58-aff0-4794-bd35-9f8c74548470
begin
N = 80
M = round(Int, N/4)
Random.seed!(1234)
...
# ╔═╡ 780469b7-b44a-404a-80c3-8cf53e13622a
md"## Building a Neural Network"

# ╔═╡ 917235c9-92fc-4c69-b0f1-8f3db2972903
md"ベイズニューラルネットワークは、従来のニューラルネットワーク(以下、NN)のようにパラメータを1点(定数)ではなく、分布として表現します。今回は入力から出力に向かって逆伝播しないフィードフォワードのNNを構築します。Fluxパッケージでは、隠れ層をDenseで定義し、Chainを使ってそれらを結びつけます。作成したネットワークはtanh活性化をもつ二つの隠れ層とシグモイド(σ)活性化をもつ一つの出力層を有しています。"

# ╔═╡ 45ee4fd1-e28d-47f7-a12c-70ee193d98d7
begin
...
# ╔═╡ e0597dd7-fed6-46d0-897f-e9d004b02ab2
...
# ╔═╡ 6ff14cfa-e565-4ab6-bce1-cdb681e23c33
function nn_predict(x, theta, num)
    return mean([nn_forward(x, theta[i, :])[1] for i in 1:10:num])
end;

# ╔═╡ 23daaf3f-705a-497c-bede-d07212858910


# ╔═╡ 6fe52ec6-dd51-400e-8082-dbe6452c0d68
...
julia_version = "1.8.1"
manifest_format = "2.0"
project_hash = "52b869ceb2f168d1c74f4d0e17b52e09eedd43b7"
...
git-tree-sha1 = "ee393df18602fb7cc5584ff22f4c9fe9a97f889a"
